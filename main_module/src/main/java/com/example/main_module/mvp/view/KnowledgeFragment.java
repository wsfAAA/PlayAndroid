...
import com.example.main_module.adapter.LeftNavigationViewBinder;
import com.example.main_module.adapter.RightNavigationViewBinder;
...
public class KnowledgeFragment extends BaseMvpFragment<KnowledgePresenter> {
    ...
    @BindView(R2.id.m_left_recycler_view)
    StopAppBarRecyclerView mLeftRecyclerView;
    @BindView(R2.id.m_right_recycler_view)
