...
import test.opendingding.com.othermodule.view.core.image.EnjoyImageView;
    ...
    private void setRestrict() {
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                Log.i("wsf","left:  "+mLayerView.getLeft()+"   right: "+mLayerView.getRight()+"   bottom: "+mLayerView.getBottom()+"   top: "+mLayerView.getTop());
