 ...
 * 双击 缩放、移动图片
 */
public class PicScaleView extends AppCompatImageView implements OnGlobalLayoutListener, OnScaleGestureListener, OnTouchListener {
    ...
    public PicScaleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PicScaleView(Context context) {
        this(context, null);
    }

    public PicScaleView(Context context, AttributeSet attrs, int defStyle) {
